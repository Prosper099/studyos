export default {
    ...
    color: 'orange', icon: '🏺', blurb: 'Nigerian civilisations, pre-colonial states and the story of how we got here.',
    topics: {
      SS1: [
        {
          title: 'History as a Discipline & Sources of History',
          tags: ['Primary sources', 'Secondary sources', 'Oral tradition', 'Archaeology'],
          summary: 'What history is, why it matters, and the raw materials — sources — historians build the past from.',
          content: `
          ...
          `,
          quiz: [
            { q: 'History is best defined as', options: ['stories about kings', 'the evidence-based study of the human past', 'the study of maps', 'memorising dates'], correct: 1, exp: 'History argues from evidence about the past.' },
            { q: 'A diary written during an event is a', options: ['secondary source', 'primary source', 'myth', 'legend'], correct: 1, exp: 'First-hand from the period.' },
            { q: 'A modern textbook interpreting old events is', options: ['primary', 'secondary', 'oral', 'archaeological'], correct: 1, exp: 'It interprets rather than witnesses.' },
            { q: 'Praise poems and folk tales belong to', options: ['archaeology', 'oral tradition', 'linguistics', 'cartography'], correct: 1, exp: 'Spoken memory passed down.' },
            { q: 'Studying material remains like potsherds is', options: ['oral tradition', 'archaeology', 'anthropology', 'economics'], correct: 1, exp: 'Archaeology digs the past.' },
            { q: 'Nok terracotta is an example of which source?', options: ['written', 'archaeological', 'oral', 'audio'], correct: 1, exp: 'Material remains unearthed.' },
            { q: 'A weakness of oral tradition is', options: ['it never changes', 'memory can shrink or inflate events', 'it is always written', 'it needs no interpreter'], correct: 1, exp: 'Spoken memory distorts over generations.' },
            { q: 'Linguistics helps history by', options: ['dating rocks', 'tracing word borrowing and migrations', 'counting stars', 'drawing maps'], correct: 1, exp: 'Language movement records people movement.' },
            { q: 'Why study history?', options: ['to repeat mistakes', 'for identity, judgment and planning', 'only for exams', 'to hate neighbours'], correct: 1, exp: 'Identity, lessons and better planning.' },
            { q: 'Cross-checking sources is called', options: ['forgery', 'cross-examination of evidence', 'myth-making', 'censorship'], correct: 1, exp: 'Historians test sources against each other.' }
          ],
          cards: [
            { q: 'Define history.', a: 'The systematic, evidence-based study of the human past.' },
            { q: 'Give two uses of history.', a: 'It builds identity and citizenship, and teaches judgment for planning.' },
            { q: 'What is a primary source?', a: 'A first-hand record from the period studied — diaries, treaties, coins.' },
            { q: 'What is a secondary source?', a: 'A later account built from primary sources — textbooks, biographies.' },
            { q: 'What is oral tradition?', a: 'Spoken memory passed across generations — praise poems, folk tales, king lists.' },
            { q: 'What is archaeology?', a: 'The study of material remains excavated from the ground.' },
            { q: 'Give one archaeological source in Nigeria.', a: 'Nok terracotta figures or the Benin walls.' },
            { q: 'Name a strength of written sources.', a: 'They fix detail exactly as recorded at the time.' },
            { q: 'Name a weakness of oral tradition.', a: 'Memory can shrink, inflate or reshape events over time.' },
            { q: 'How does linguistics assist history?', a: 'Word borrowing and language spread trace migrations and contact.' },
            { q: 'How does anthropology assist history?', a: 'By studying cultures and customs that preserve the past.' },
            { q: 'Is an old book always primary?', a: 'No — primary/secondary depends on witnessing vs interpreting, not age.' },
            { q: 'What is bias in a source?', a: 'The slant from the maker&apos;s interest, flattery or limited view.' },
            { q: 'Why cross-examine sources?', a: 'Because each carries bias; agreement between independent sources builds reliability.' },
            { q: 'History is an argument from what?', a: 'From evidence — sources tested against each other.' }
          ],
        },
        {
          title: 'Pre-Colonial Nigerian Societies: Igbo, Yoruba & Hausa-Fulani Administration',
          tags: ['Age grades', 'Oyo Mesi', 'Emirate system', 'Checks on power'],
          summary: 'How pre-colonial Nigerian societies governed themselves — village democracy, checks on kings, and the emirate system.',
          content: `
          ...
          `,
          quiz: [
            { q: 'Pre-colonial Igbo society is described as', options: ['highly centralised', 'acephalous/decentralised', 'military dictatorship', 'a colony'], correct: 1, exp: 'Authority was dispersed among institutions.' },
            { q: 'Igbo communal decisions were often taken by', options: ['the emir', 'the village assembly', 'the Alaafin', 'the sultan'], correct: 1, exp: 'Consensus in the village square.' },
            { q: 'Age grades were', options: ['school classes', 'year-sets performing communal duties', 'tax offices', 'royal titles'], correct: 1, exp: 'Age sets did work and policing.' },
            { q: 'The Arochukwu oracle was called', options: ['Ogboni', 'Ibini Ukpabi', 'Oyo Mesi', 'Zamakowa'], correct: 1, exp: 'A spiritual court of appeal.' },
            { q: 'The Alaafin ruled which kingdom?', options: ['Benin', 'Oyo', 'Kanem', 'Kano'], correct: 1, exp: 'The Alaafin was the king of the Oyo empire.' },
            { q: 'The Oyo Mesi were', options: ['seven kingmakers checking the Alaafin', 'army slaves', 'traders', 'priests of Sango only'], correct: 0, exp: 'The council of kingmakers.' },
            { q: 'Who led the Oyo Mesi?', options: ['Bashorun', 'Galadima', 'Waziri', 'Oba'], correct: 0, exp: 'The Bashorun headed the council.' },
            { q: 'The Ogboni served as', options: ['a check on king and council', 'a market union', 'a cavalry', 'a tax farm'], correct: 0, exp: 'A judicial brotherhood balancing power.' },
            { q: 'The 1804 jihad was led by', options: ['Mai Idris Alooma', 'Usman dan Fodio', 'Queen Amina', 'Jaja'], correct: 1, exp: 'Founder of the Sokoto Caliphate.' },
            { q: 'The head of the Sokoto Caliphate was the', options: ['Emir of Kano', 'Sultan', 'Alaafin', 'Obi'], correct: 1, exp: 'The Sultan at Sokoto.' },
            { q: 'Islamic judges in the emirates were called', options: ['alkali', 'waziri', 'balogun', 'ozo'], correct: 0, exp: 'Alkali courts applied Sharia.' },
            { q: 'The British kept which system for indirect rule?', options: ['village assembly', 'emirate system', 'oracle cult', 'age grades'], correct: 1, exp: 'The emirates made indirect rule easy in the north.' }
          ],
          cards: [
            { q: 'What does acephalous mean for Igbo society?', a: 'Power was decentralised — no single central king; institutions shared authority.' },
            { q: 'Name two Igbo institutions.', a: 'Village assembly, council of elders, age grades, title societies, oracle.' },
            { q: 'What were age grades?', a: 'Sets of people born in the same period who did communal work and policing.' },
            { q: 'What was the Ibini Ukpabi?', a: 'The Arochukwu oracle — a spiritual court of appeal.' },
            { q: 'Who was the Alaafin?', a: 'The king of the Oyo empire.' },
            { q: 'Who were the Oyo Mesi?', a: 'The council of seven kingmakers who checked the Alaafin.' },
            { q: 'How was a tyrant Alaafin removed?', a: 'The Oyo Mesi sent an empty calabash — a command to die.' },
            { q: 'What was the Ogboni?', a: 'A powerful brotherhood that checked both king and council.' },
            { q: 'Who founded the Sokoto Caliphate?', a: 'Usman dan Fodio after the 1804 jihad.' },
            { q: 'Who headed the Sokoto Caliphate?', a: 'The Sultan (Amir al-Mu&apos;minin) at Sokoto.' },
            { q: 'What is an emirate?', a: 'A province of the caliphate ruled by an Emir under the Sultan.' },
            { q: 'Name two emirate officials.', a: 'Waziri, Galadima, Madawaki, Dogari.' },
            { q: 'What law ran the emirate courts?', a: 'Islamic law (Sharia) via alkali courts.' },
            { q: 'Which system did the British reuse?', a: 'The emirate system, for indirect rule in the north.' },
            { q: 'Common thread across the three systems?', a: 'Built-in checks against tyranny — assemblies, councils or Sharia.' }
          ],
        },
      ],
      SS2: [
    ...
    resources: [
      { cat: 'Past questions', title: 'Myschool — History past questions', url: 'https://myschool.ng/classroom', note: 'Past WASSCE/UTME history questions.' },
      { cat: 'Reference', title: 'Wikipedia — Nok culture', url: 'https://en.wikipedia.org/wiki/Nok_culture', note: 'Terracotta art and early iron.' },
      { cat: 'Reference', title: 'Wikipedia — Oyo Empire', url: 'https://en.wikipedia.org/wiki/Oyo_Empire', note: 'Constitutional monarchy and checks.' },
      { cat: 'Reference', title: 'Wikipedia — Sokoto Caliphate', url: 'https://en.wikipedia.org/wiki/Sokoto_Caliphate', note: 'The 1804 jihad and the emirate system.' }
    ]
