...
export const SS1_EXPANSION = {
  ...
  'Economics': {
    'What Economics Is: Scarcity, Choice & Opportunity Cost': [
      ...
      { q: 'The opportunity cost of any choice is...', options: ['the next best alternative forgone', 'every alternative forgone', 'the money spent only', 'the time spent only'], correct: 0, exp: 'Only the next best alternative counts as opportunity cost - not all alternatives and not just the money.' },
      ...
      { q: 'What does capital earn as a factor of production?', options: ['interest', 'rent', 'wages', 'royalty only'], correct: 0, exp: 'Capital earns interest; land earns rent, labour earns wages and the entrepreneur earns profit.' },
  ...
  'Financial Accounting': {
    'Introduction to Accounting & the Accounting Equation': [
      ...
      { q: 'Which relationship is always true under double entry?', options: ['Assets = Capital + Liabilities', 'Assets = Capital - Liabilities', 'Capital = Assets + Liabilities', 'Liabilities = Assets + Capital'], correct: 0, exp: 'The business\'s resources are always financed by the owner\'s fund plus what it owes outsiders.' },
      ...
      { q: 'Creditors and bank loans are examples of...', options: ['liabilities', 'assets', 'capital', 'drawings'], correct: 0, exp: 'Both are debts the business owes to outsiders - liabilities on the statement of financial position.' },
    ...
    'Source Documents & Books of Original Entry': [
      ...
      { q: 'Where do cash sales first get entered?', options: ['cash book', 'sales journal', 'purchases journal', 'ledger'], correct: 0, exp: 'The cash book records every cash and cheque receipt and payment; the sales journal takes only credit sales.' },
