#!/usr/bin/env python3
"""Insert Commerce SS2 + SS3 (3 topics each) into index.html CURRICULUM. RUN ONCE."""
import sys

P = 'index.html'
s = open(P, encoding='utf-8').read()

assert "title: 'Wholesale & Retail Trade: Channels of Distribution'" not in s, 'already applied — do not re-run'
...
print('commerce ss2+ss3 inserted')
