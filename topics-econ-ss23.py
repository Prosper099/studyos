#!/usr/bin/env python3
"""Insert Economics SS2 + SS3 (3 topics each) into index.html CURRICULUM. RUN ONCE."""
import sys

P = 'index.html'
s = open(P, encoding='utf-8').read()

assert "title: 'Demand, Supply & Price Determination'" not in s, 'already applied — do not re-run'
